...
TEST(ardupilotmega, AvoidControlFlow)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::ardupilotmega::msg::AvoidControlFlow packet_in{};
    packet_in.suggest_move_x = 963497464;
    packet_in.suggest_move_y = 963497672;
    packet_in.suggest_move_z = 963497880;
    packet_in.prefer_target_x = 963498088;
    packet_in.prefer_target_y = 963498296;
    packet_in.prefer_target_z = 963498504;
    packet_in.reservered_param = {{ 185.0, 186.0, 187.0, 188.0 }};

    mavlink::ardupilotmega::msg::AvoidControlFlow packet1{};
    mavlink::ardupilotmega::msg::AvoidControlFlow packet2{};
    ...
    EXPECT_EQ(packet1.suggest_move_x, packet2.suggest_move_x);
    EXPECT_EQ(packet1.suggest_move_y, packet2.suggest_move_y);
    EXPECT_EQ(packet1.suggest_move_z, packet2.suggest_move_z);
    EXPECT_EQ(packet1.prefer_target_x, packet2.prefer_target_x);
    EXPECT_EQ(packet1.prefer_target_y, packet2.prefer_target_y);
    EXPECT_EQ(packet1.prefer_target_z, packet2.prefer_target_z);
    EXPECT_EQ(packet1.reservered_param, packet2.reservered_param);
}

#ifdef TEST_INTEROP
TEST(ardupilotmega_interop, AvoidControlFlow)
{
    mavlink_message_t msg;
    ...
    mavlink_avoidcontrolflow_t packet_c {
    ...
    mavlink_msg_avoidcontrolflow_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.suggest_move_x, packet2.suggest_move_x);
    EXPECT_EQ(packet_in.suggest_move_y, packet2.suggest_move_y);
    EXPECT_EQ(packet_in.suggest_move_z, packet2.suggest_move_z);
    EXPECT_EQ(packet_in.prefer_target_x, packet2.prefer_target_x);
    EXPECT_EQ(packet_in.prefer_target_y, packet2.prefer_target_y);
    EXPECT_EQ(packet_in.prefer_target_z, packet2.prefer_target_z);
    EXPECT_EQ(packet_in.reservered_param, packet2.reservered_param);
